...
# next: goes to the next line in the same scope
# continue: runs until next debugger or end of program
# up: back to the scope where the current method was called
#      does NOT undo what was executed
...
def jumble_sort(str, alphabet = nil)
  # LAZY INITIALIZATION - if alphabet is nil, set it to this thing
  alphabet ||= ('a'..'z').to_a
