...
# First we get all the movies that Chris Farley was in. That's what we use chris_actor
# and chris_casting for. Then we get all the lead actors in those movies. That's
# what we use lead_casting and lead_actor for.
def chris_is_missed
  MovieDatabase.execute(<<-SQL)
  SELECT
