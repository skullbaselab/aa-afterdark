...
var _xarvh$elm_slides$Slides_SlideAnimation$scroll = function (status) {
	var position = function () {
		...
		if (_p3.ctor === 'Still') {
			...
			var offset = function () {
				var _p4 = _p3._1;
				if (_p4.ctor === 'EarlierSlide') {
					return 0;
				} else {
					return 100;
				}
			}();
			return offset - (_p3._2 * 100);
		}
	}();
	return _rtfeldman$elm_css$Css$asPairs(
		{
...
var _xarvh$elm_slides$Slides_Styles$whiteOnBlack = {
	ctor: '::',
...
var _xarvh$elm_slides$Slides$slidesDefaultOptions = {
	style: _xarvh$elm_slides$Slides_Styles$whiteOnBlack,
	slideAnimator: _xarvh$elm_slides$Slides_SlideAnimation$scroll,
...
var _user$project$Main$main = A2(
	...
	_elm_lang$core$Native_Utils.update(
		...
		{style: _user$project$Main$style}),
	{
		ctor: '::',
		_0: _xarvh$elm_slides$Slides$md('# Recursion'),
		_1: {
			ctor: '::',
			_0: _xarvh$elm_slides$Slides$mdFragments(
				{
					ctor: '::',
					_0: 'What is a recursive method?',
					_1: {
						ctor: '::',
			...
			_1: {
				...
				_0: _xarvh$elm_slides$Slides$mdFragments(
					{
						ctor: '::',
						_0: 'The two basic requirements of a _useful_ recursive method?',
						_1: {
							ctor: '::',
							_0: '1) Base case',
							_1: {
				...
				_1: {
					ctor: '::',
					_0: _xarvh$elm_slides$Slides$md('# How many coffees do we need to order?'),
					_1: {
						ctor: '::',
