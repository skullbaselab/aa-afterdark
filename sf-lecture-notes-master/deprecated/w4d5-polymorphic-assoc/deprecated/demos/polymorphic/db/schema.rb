...
ActiveRecord::Schema.define(version: 20151119192502) do
  ...
  add_index "swords", ["swordable_id", "swordable_type"], name: "index_swords_on_swordable_id_and_swordable_type", using: :btree
