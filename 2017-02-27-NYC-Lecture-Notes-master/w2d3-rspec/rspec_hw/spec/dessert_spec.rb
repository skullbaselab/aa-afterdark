...
describe Dessert do
  ...
  describe "#initialize" do
    ...
    it "starts ingredients as an empty array" do
      ...
      # expect(brownie.ingredients.empty?).to be true
    end
  ...
  describe "#make_more" do
    it "calls bake on the dessert's chef with the dessert passed in" do
      ...
      #will fail if chef does not receive bake method with brownie as argument
      brownie.make_more #not testing return value of #make_more
    end
  end
end
