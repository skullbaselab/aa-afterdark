...
class MemoryGame
  ...
  def make_guess(pos)
    ...
    self.player.receive_revealed_card(pos, revealed_value)
    # self.player is an instance of either HumanPlayer or ComputerPlayer
    # so we've written this method on both classes
    # the one on the human player does nothing, this is an instance of duck-typing
    board.render
