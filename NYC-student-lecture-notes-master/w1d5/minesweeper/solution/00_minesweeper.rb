...
class Board
  ...
  # attr_writer :num_bombs

  # equivalent to attr_reader :grid_size
  # def grid_size
  #   @grid_size
  # end
  #
  # equivalent to attr_writer :num_bombs
  # def num_bombs=(num)
  #   @num_bombs = num
  # end

  # attr_accessor makes both of these

  def initialize(grid_size, num_bombs)
    @grid_size, @num_bombs = grid_size, num_bombs
    # self.num_bombs = 3 # when using setters, you have to use `self`
    generate_board
  end
