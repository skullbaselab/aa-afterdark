...
RSpec.describe LinksController, :type => :controller do
    ...
    context "when logged in" do
      ...
      context "with valid params" do
        it "redirects to the link show page" do
          ...
          #the data after the comma are the params
  ...
  describe "GET #index" do
    context "when logged in" do
      ...
      #using factory girl via the line in our config file
      ...
      it "renders the new links page" do
        ...
        #assigns allows us to test the value of an instance variable named "links"
      end
    end
