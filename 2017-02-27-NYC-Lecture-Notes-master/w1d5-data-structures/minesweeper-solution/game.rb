...
class MinesweeperGame
  ...
  def play # look at how short this method is!
    until @board.won? || @board.lost?
      puts @board.render

      action, pos = get_move # destructures the array that #get_move returns
  ...
  def save
    ...
    File.write(filename, YAML.dump(self)) # converts this Ruby object into YAML
  end
end
