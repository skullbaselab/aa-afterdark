require "set"
# require comes from ruby's guts
require_relative "player"
#  require_relative for your own files that you want to include
...
class GhostGame
  ...
  # these methods cannot be called with the . - the explicit caller
  # you ARE allowed to call instance methods implicitly
  ...
  def take_turn(player)
    # system("clear")
    # string interpolation is calling to #to_s method automatically
  ...
  def winner
    # losses is a hash - #find requires 2 args: key, value
    # we aren't interested in the key here, by convention we use
    #  _ to indicate we aren't interested in this variable
    # no technical difference, indication to human code reader
...
# this will only run if this file was run directly on the command line
#  ie: ruby ghost.rb
