...
## Marketplaces
Fill these out once and check them every now and then. Some require coding tests.  The coding challenges can be tough so take a couple [HackerRank][hackerrank] tests to prepare.
  ...
  * [Shapr][shapr] - connecting with career minded professionals via an app
...
[sequoia]: http://jobs.sequoiacap.com/careers_home.php?ind=&bayVals=1,2,3,4,5&usVals=13&globalVals=&stag=&func=12&tech=12&buss=
