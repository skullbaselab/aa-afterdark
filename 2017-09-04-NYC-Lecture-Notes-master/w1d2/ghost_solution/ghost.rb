require "set"
# require says find "set" library from Ruby
require_relative "player"
# require relative basically
# says copy pase the code from player.rb
# this looks for local File

class GhostGame
  ALPHABET = Set.new("a".."z")
  MAX_LOSS_COUNT = 5
# Sets give us constant lookup times.
# no need to iterate over the entire dictioanry
  ...
  # the below is called parallel assignment.
  # assigning player and _ to the return value of losses.find
  # the parens around the variables player and _ is just to be explicit
  # the underscore is simply a variable!!
  # meaning, we don't care what it represents
  def winner
  ...
  def take_turn
    ...
    until letter
      letter = current_player.guess(self.fragment)
...
# ARGV[0] allows you to replace arguments and, replace the
# argument with the first arg passed in to the command line
# what this is saying is run the below code if
# this file name is the same as the program name
