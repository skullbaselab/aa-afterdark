...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__connect_connect__ = __webpack_require__(171);
...
exports.destroyStep = exports.updateStep = exports.createStep = exports.requestSteps = exports.removeStep = exports.receiveStep = exports.receiveSteps = exports.REMOVE_STEP = exports.RECEIVE_STEP = exports.RECEIVE_STEPS = undefined;

var _step_api_util = __webpack_require__(161);
...
// async actions
var requestSteps = exports.requestSteps = function requestSteps(todoId) {
  return function (dispatch) {
    return StepAPIUtil.fetchSteps(todoId).then(function (steps) {
...
var destroyStep = exports.destroyStep = function destroyStep(step) {
  return function (dispatch) {
    return StepAPIUtil.destroyStep(step).then(function (step) {
...
exports.deleteTodo = exports.updateTodo = exports.createTodo = exports.fetchTodo = exports.fetchTodos = exports.todoError = exports.removeTodo = exports.receiveTodo = exports.receiveTodos = exports.TODO_ERROR = exports.REMOVE_TODO = exports.RECEIVE_TODO = exports.RECEIVE_TODOS = undefined;

var _todo_api_util = __webpack_require__(93);

var TodoAPIUtil = _interopRequireWildcard(_todo_api_util);

var _error_actions = __webpack_require__(41);
...
var createTodo = exports.createTodo = function createTodo(todoFromComponent) {
  return function (dispatch) {
    debugger;
    var promise = TodoAPIUtil.createTodo(todoFromComponent).then(function (todoFromDatabase) {
      debugger;
...
var deleteTodo = exports.deleteTodo = function deleteTodo(todo) {
  return function (dispatch) {
    return TodoAPIUtil.destroyTodo(todo).then(function (todo) {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_invariant__ = __webpack_require__(169);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_invariant___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1_invariant__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_react__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_react___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_2_react__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__utils_Subscription__ = __webpack_require__(170);
...
var _thunk_middleware = __webpack_require__(163);
...
var _error_reducer = __webpack_require__(162);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__utils_shallowEqual__ = __webpack_require__(172);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__mapDispatchToProps__ = __webpack_require__(173);
...
var _todo_list = __webpack_require__(180);
...
var _todo_list_item = __webpack_require__(181);

var _todo_list_item2 = _interopRequireDefault(_todo_list_item);

var _todo_form = __webpack_require__(189);
...
var _todo_detail_view_container = __webpack_require__(182);
...
var _todo_detail_view = __webpack_require__(183);
...
var mapDispatchToProps = function mapDispatchToProps(dispatch, _ref) {
  ...
  return {
    requestSteps: function requestSteps() {
      return dispatch((0, _step_actions.requestSteps)(todo.id));
    },
...
var _step_list_container = __webpack_require__(184);
  ...
  _createClass(TodoDetailView, [{
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          'button',
          { className: 'delete-button', onClick: destroyTodo },
          'Delete Todo'
        ),
        _react2.default.createElement(
          'ul',
...
var _step_list = __webpack_require__(185);
...
var mapDispatchToProps = function mapDispatchToProps(dispatch, ownProps) {
  return {
    createStep: function createStep() {
      return dispatch(_step_actions.createStep.apply(undefined, arguments));
    }
  };
};
...
var _step_list_item_container = __webpack_require__(186);

var _step_list_item_container2 = _interopRequireDefault(_step_list_item_container);

var _step_form = __webpack_require__(188);
...
var _step_list_item = __webpack_require__(187);
...
var mapDispatchToProps = function mapDispatchToProps(dispatch, _ref) {
  ...
  return {
    ...
    updateStep: function updateStep(updatedStep) {
      return dispatch((0, _step_actions.updateStep)(updatedStep));
    }
  };
};
// Actions
...
var StepListItem = function (_React$Component) {
  ...
  _createClass(StepListItem, [{
    ...
    value: function toggleStep(e) {
      var toggledStep = (0, _merge2.default)({}, this.props.step, {
...
var _error_list = __webpack_require__(190);
...
var TodoForm = function (_React$Component) {
  ...
  _createClass(TodoForm, [{
    ...
    value: function handleSubmit(e) {
      ...
      // prevent default because forms usually like to submit get requests and refresh our page and ruin everything
      e.preventDefault();
      // new object version of our local component state
      // because we really want to make sure the real state doesn't get modified
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            'button',
            { type: 'button', className: 'button', onClick: this.addTag },
            'Add Tag'
          )
        ),
        _react2.default.createElement(
